 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: prc_timer.h 1596 2009-06-29 09:41:45Z ertl-honda $
 */
 ...
 *  タイマ割込みハンドラ登録のための定数
 */
#define INHNO_TIMER     TMU0_INTEVT   /* 割込みハンドラ番号 */
#define INTNO_TIMER     TMU0_INTEVT   /* 割込み番号 */
...
{
    return(TO_CLOCK(TIC_NUME, TIC_DENO) - sil_rew_mem((void*)TMU_TCNT0));
}
...
{
    return(sil_reh_mem((void*)TMU_TCR0) & TCR_UNF);
}
