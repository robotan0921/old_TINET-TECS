 ...
 *  SIOの割込みハンドラのベクタ番号
 */
#define INHNO_SIO_TX     SCIF0_TXI_INTEVT /* 割込みハンドラ番号 */
#define INTNO_SIO_TX     SCIF0_TXI_INTEVT /* 割込み番号 */
#define INHNO_SIO_RX     SCIF0_RXI_INTEVT /* 割込みハンドラ番号 */
#define INTNO_SIO_RX     SCIF0_RXI_INTEVT /* 割込み番号 */
