 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: target_syssvc.h 1598 2009-06-29 09:43:33Z ertl-honda $
 */

/*
 *  システムサービスのターゲット依存部（APSH4A用）
 *
 ...
 *  起動メッセージのターゲットシステム名
 */
//#define TARGET_NAME    "APSH4A(SH7780)"
#define TARGET_NAME    "APSH4A(SH7786)"
 ...
 *  シリアルポートの割込み番号
 */
#define SCIF0_RXI_INTNO SCIF0_TXI_INTEVT
#define SCIF0_TXI_INTNO SCIF0_RXI_INTEVT
